...
const BgGlassmorphism: FC<BgGlassmorphismProps> = ({
  ...
  return (
    ...
    >
      <span className="bg-primary w-80 h-80 rounded-full mix-blend-multiply filter blur-3xl opacity-20 lg:w-96 lg:h-9w-96" />
      <span className="bg-secondary w-80 h-80 ml-10 -mt-10 rounded-full mix-blend-multiply filter blur-3xl opacity-20 lg:w-96 lg:h-9w-96 nc-animation-delay-2000" />
    </div>
  );
};
